...
namespace Skrypton.Tests.RuntimeSupport.Implementations
{
    ...
    public class MOD : TestBase
    {
        ...
        {
            myAssert.AreEqual(expectedResult, DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().MOD(l, r));
        }
        ...
        public void TypeMismatchCases(string description, object l, object r)
        {
            ...
            {
                DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().MOD(l, r);
            });
        }

        [TestMethod, MyTheory, MyMemberData("DivisionByZeroData")]
        public void DivisionByZeroCases(string description, object l, object r)
        {
            myAssert.Throws<VBScriptDivisionByZeroException>(() =>
            {
                DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().MOD(l, r);
            });
        }

...
namespace Skrypton.Tests.RuntimeSupport.Implementations
{
    ...
    public class DAY : TestBase
    {
        ...
        {
            myAssert.AreEqual(expectedResult, DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().DAY(value));
        }
        ...
        public void TypeMismatchCases(string description, object value)
        {
            myAssert.Throws<TypeMismatchException>(() =>
                {
                    DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().DAY(value);
                });
        }

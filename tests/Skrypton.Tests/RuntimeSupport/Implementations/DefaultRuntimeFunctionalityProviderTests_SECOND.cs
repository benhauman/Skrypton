...
namespace Skrypton.Tests.RuntimeSupport.Implementations
{
    ...
    public class SECOND : TestBase
    {
        ...
        {
            myAssert.AreEqual(expectedResult, DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().SECOND(value));
        }
        ...
        public void TypeMismatchCases(string description, object value)
        {
            ...
            {
                DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().SECOND(value);
            });
        }
        ...
        public static IEnumerable<object[]> SuccessData
        {
            get
            {
                ...
                yield return new object[] { "Largest positive integer before overflow + 0.02", 2958465.002, 53 }; // lubo: old:52
                ...
                yield return new object[] { "Largest positive integer before overflow + 0.9", 2958465.9, 0 }; // lubo: old:59
                ...
                yield return new object[] { "Largest positive integer before overflow + 0.999", 2958465.999, 34 }; // lubo: old:33

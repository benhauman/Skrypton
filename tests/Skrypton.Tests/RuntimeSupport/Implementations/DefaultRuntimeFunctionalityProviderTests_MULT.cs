...
namespace Skrypton.Tests.RuntimeSupport.Implementations
{
    ...
    public class MULT : TestBase
    {
        ...
        {
            myAssert.AreEqual(expectedResult, DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().MULT(l, r));
        }
        ...
        public void TypeMismatchCases(string description, object l, object r)
        {
            ...
            {
                DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().MULT(l, r);
            });
        }

...
namespace Skrypton.Tests.RuntimeSupport.Implementations
{
    ...
    public class ISNUMERIC : TestBase
    {
        ...
        {
            myAssert.True(DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().ISNUMERIC(value));
        }

        [TestMethod, MyTheory, MyMemberData("FalseData")]
        public void FalseCases(string description, object value)
        {
            myAssert.False(DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().ISNUMERIC(value));
        }

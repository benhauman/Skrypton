...
namespace Skrypton.Tests.RuntimeSupport.Implementations
{
    ...
    public class VBScriptEsqueValueRetrieverTests : TestBase
    {
        ...
        public void EnsureThatOldArgumentsAreNotReusedInSubsequentIDispatchCalls()
        {
            ...
            {
                _.SETm0a1(context: dict, target: dict, "a", 1);
                _.SETm0a1(context: dict, target: dict, "b", 2);
                myAssert.AreEqual(2, _.CALLm1v0(context: null, target: dict, member1: "Count"));
            }
        }
        ...
        */
        ...
        public void ByRefArgumentIsUpdatedAfterCall()
        {
            var _ = DefaultRuntimeSupportClassFactoryInstance.DefaultVBScriptValueRetriever;
            object arg0 = 1;
            _.CALLm1argp(context: null, target: this, member1: "ByRefArgUpdatingFunction", argumentProviderBuilder: _.ARGS.Ref(arg0, v => { arg0 = v; }).Val(false));
        ...
        public void ByRefArgumentIsUpdatedAfterCallEvenIfExceptionIsThrown()
        {
            ...
            try
            {
                _.CALLm1argp(context: null, target: this, member1: "ByRefArgUpdatingFunction", argumentProviderBuilder: _.ARGS.Ref(arg0, v => { arg0 = v; }).Val(true));
            }
            catch { }
            myAssert.AreEqual(123, arg0);
        }
        ...
        {
            var _ = DefaultRuntimeSupportClassFactoryInstance.DefaultVBScriptValueRetriever;
            myAssert.AreEqual(2, _.CALLm1argp(context: null, target: this, member1: "GetNumberOfArgumentsPassedInParamsObjectArray", argumentProviderBuilder: _.ARGS.Val(1).Val(2)));
        }
        ...
        public void StringMemberAccessorValuesShouldNotBeRewrittenAtTranslationTime()
        {
            ...
            myAssert.AreEqual(
                "Success!",
                _.CALLm1v0(context: null, target: new ImpressionOfTranslatedClassWithRewrittenPropertyName(), member1: "Params")
            );
        }
        ...
        public void DispIdZeroPropertySettingWorksWithValueTypes()
        {
            ...
            {
                _.SETm0a1(context: dict, target: dict, "ACCO", valueToSetTo: valueTypeValueToRecord);
            }
        }
        ...
        public void DispIdZeroPropertySettingWorksWithReferenceTypes()
        {
            ...
            using (var _ = DefaultRuntimeSupportClassFactoryInstance.Get())
            {
                _.SETm0a1(context: dict, target: dict, arg1: "ACCO", valueToSetTo: referenceTypeValueToRecord);
            }
        }
        ...
        public void CallPrivateMemberFromWithinContextOfClassShouldWork()
        {
            ...
            myAssert.AreEqual(
                name,
                _.CALLm1v0(context: classWithPrivateMember, target: classWithPrivateMember, member1: "GetName")
            );
        }
        ...
        public void CallPrivateMemberFromOutsideContextOfClassShouldThrow()
        {
            ...
            myAssert.Throws<MissingMemberException>(() =>
                _.CALLm1v0(context: null, target: classWithPrivateMember, member1: "GetName")
            );
        }
        ...
        public void SettingPrivatePropertyFromWithinContextOfClassShouldWork()
        {
            ...
            var _ = DefaultRuntimeSupportClassFactoryInstance.DefaultVBScriptValueRetriever;
            _.SETm1a0(context: classWithPrivateMember, target: classWithPrivateMember, memberAccessor: "Name", valueToSetTo: name);
            myAssert.AreEqual(
                name,
        ...
        public void SettingPrivatePropertyFromOutsideContextOfClassShouldThrow()
        {
            ...
            var _ = DefaultRuntimeSupportClassFactoryInstance.DefaultVBScriptValueRetriever;
            myAssert.Throws<MissingMemberException>(() =>
                _.SETm1a0(context: null, target: classWithPrivateMember, memberAccessor: "Name", valueToSetTo: name)
            );
        }
        ...
        public void SettingPrivateIndexedPropertyFromWithinContextOfClassShouldWork()
        {
            ...
            var _ = DefaultRuntimeSupportClassFactoryInstance.DefaultVBScriptValueRetriever;
            _.SETm1a1(context: classWithPrivateMember, target: classWithPrivateMember, memberAccessor: "Test", arg1: i, valueToSetTo: name);
            myAssert.AreEqual(
                name,
        ...
        public void SettingPrivateIndexedPropertyFromOutsideContextOfClassShouldThrow()
        {
            ...
            myAssert.Throws<MissingMethodException>(() =>
                _.SETm1a1(context: null, target: classWithPrivateMember, memberAccessor: "Test", arg1: i, valueToSetTo: name)
            );
        }
        ...
        public void ByRefIndexArgumentOnPublicPropertySetterShouldAcceptUpdatesWhenCalledOverIReflect()
        {
            ...
            object value = "xyz";
            var _ = DefaultRuntimeSupportClassFactoryInstance.DefaultVBScriptValueRetriever;
            _.SETm1a1(context: null, target: new ClassWithPublicIndexedPropertyThatHasByRefArguments(), memberAccessor: "Test",// argp
        ...
        public void ByRefIndexArgumentOnPublicPropertySetterShouldAcceptUpdatesWhenNotCalledOverIReflect()
        {
            ...
            object value = "xyz";
            var _ = DefaultRuntimeSupportClassFactoryInstance.DefaultVBScriptValueRetriever;
            _.SETm1a1(context: null, target: new ClassWithPublicIndexedPropertyThatHasByRefArgumentsButThatIsNotCalledOverIReflect(), memberAccessor: "Test",
                arg1: i,// lubo: argumentProviderBuilder: _.ARGS.Ref(i, iUpdate => { i = iUpdate; })
                valueToSetTo: value
            );
            myAssert.AreEqual(i, 123); //lubo: "456");
...
#pragma warning restore CA1416 // Validate platform compatibility
        ...
        public void WhenLookingForParameterLessDefaultMemberOnComVisibleClassSupportOptionalArguments()
        {
            ...
            myAssert.AreEqual(
                "YEAH!",
                _.VAL(_.CALLm0v0(context: null, target: new ClassWithDefaultMethodWithSingleOptionalArgument()))
            );
        }

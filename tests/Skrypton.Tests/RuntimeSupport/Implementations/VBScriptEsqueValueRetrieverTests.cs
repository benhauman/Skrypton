    ...
    public class VBScriptEsqueValueRetrieverTests : TestBase
    {
        ...
        public void EnsureThatOldArgumentsAreNotReusedInSubsequentIDispatchCalls()
        {
            ...
            using (var _ = Skrypton.RuntimeSupport.DefaultRuntimeSupportClassFactory.Create(CreateRuntimeHost(CreateTestHostServices()), RuntimeLogger, TestCulture).Get())
            {
                ...
                myAssert.AreEqual(2, _.CALLm1v(context: null, target: dict, member1: "Count"));
            }
        }
        ...
        */
        ...
        public void StringMemberAccessorValuesShouldNotBeRewrittenAtTranslationTime()
        {
            ...
            myAssert.AreEqual(
                "Success!",
                _.CALLm1v(context: null, target: new ImpressionOfTranslatedClassWithRewrittenPropertyName(), member1: "Params")
            );
        }
        ...
        public void CallPrivateMemberFromWithinContextOfClassShouldWork()
        {
            ...
            myAssert.AreEqual(
                name,
                _.CALLm1v(context: classWithPrivateMember, target: classWithPrivateMember, member1: "GetName")
            );
        }
        ...
        public void CallPrivateMemberFromOutsideContextOfClassShouldThrow()
        {
            ...
            myAssert.Throws<MissingMemberException>(() =>
                _.CALLm1v(context: null, target: classWithPrivateMember, member1: "GetName")
            );
        }
        ...
        public void SettingPrivatePropertyFromWithinContextOfClassShouldWork()
        {
            ...
            myAssert.AreEqual(
                name,
                _.CALLm1v(context: classWithPrivateMember, target: classWithPrivateMember, member1: "Name")
            );
        }
        ...
        */
        ...
        {
            var _ = DefaultRuntimeSupportClassFactoryInstance.DefaultVBScriptValueRetriever;
            var value = _.CALLm1v(context: null, target: new ClassWithComVisiblePropertyThatIsAlwaysNull(), member1: "Value");
...
#pragma warning restore CA1416 // Validate platform compatibility
        ...
        public void NothingShouldNotBeReturnedForNullForPropertyOfObjectType()
        {
            var _ = DefaultRuntimeSupportClassFactoryInstance.DefaultVBScriptValueRetriever;
            myAssert.Null(
                _.CALLm1v(context: null, target: new ClassWithObjectPropertyThatIsAlwaysNull(), member1: "Value")
            );
        }
        ...
        public void WhenLookingForParameterLessDefaultMemberOnComVisibleClassSupportOptionalArguments()
        {
            ...
            myAssert.AreEqual(
                "YEAH!",
                _.VAL(_.CALLm0v(context: null, target: new ClassWithDefaultMethodWithSingleOptionalArgument()))
            );
        }

...
namespace Skrypton.Tests.RuntimeSupport.Implementations
{
    ...
    public class HOUR : TestBase
    {
        ...
        {
            myAssert.AreEqual(expectedResult, DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().HOUR(value));
        }
        ...
        public void TypeMismatchCases(string description, object value)
        {
            ...
            {
                DefaultRuntimeSupportClassFactory.Create(TestCulture).Get().HOUR(value);
            });
        }

    ...
    public class CDATE : TestBase
    {
        ...
        public static IEnumerable<object[]> SuccessData
        {
            get
            {
                ...
                yield return new object[] { "Minus 400.2", -400.2, new DateTime(1898, 11, 25, 4, 48, 0) }; // This is nuts! It's like -400 then +0.2, but that's what VBScript seems to do... ("off-by-a-second")

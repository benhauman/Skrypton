...
namespace Skrypton.Tests.LegacyParser
{
    ...
    [TestClass]
    public class ChangingTests : TestBase
    {
        ...
        public void InitialWithReferencesWillBeExpandedForEaseOfManipulation()
        {
            ...
            myAssert.AreEqual(
                ...
                statement.GetBracketStandardisedTokens(withReferenceIfAny: new DoNotRenameNameToken("x", lineIndex1)),
                new TokenSetComparer()
            );
        }
    }

...
namespace TranslatedProgram
{
    ...
    public sealed class GlobalReferences : GlobalReferencesBaseT<EnvironmentReferences>
    {
        ...
        public void SetCaseAttributes(ref object hlcase, ref object mail)
        {
            ...
            try
            {
                _.CALLm1argp(this, _.NnO(oScripter, "oScripter"), "AddObject", _.ARGS.Val("hlcase").Ref(hlcase_vref, v10 => { hlcase_vref = v10; }));
            }
            finally { hlcase = hlcase_vref; }
            object mail_vref = mail;
            try
            {
                _.CALLm1argp(this, _.NnO(oScripter, "oScripter"), "AddObject", _.ARGS.Val("mail").Ref(mail_vref, v11 => { mail_vref = v11; }));
            }
            finally { mail = mail_vref; }

            _.CALLm1argp(this, _.NnO(_.CALLm0argp(this, _.NnO(_env.session, "session"), _.ARGS.Val("worker")), "(_.call result)"), "ExecuteScript", _.ARGS.Ref(oScripter, v12 => { oScripter = v12; }).Ref(_env.session, v13 => { _env.session = v13; }).Val("receive"));
        ...
        public void CreateAdhocCase(ref object oMailRequest)
        {
            ...
            //
            var enumerationContent3 = _.ENUMERABLE(_.CALLm1v0(this, _.NnO(_.CALLm1v1(this, _.NnO(_.CALLm0argp(this, _.NnO(_env.session, "session"), _.ARGS.Val("config")), "(_.call result)"), "GetGroup", "subject"), "(_.call result)"), "values")).GetEnumerator();
            while (true)
            {
        ...
        public void SetSUAttributes(ref object hlcase, ref object mail)
        {
            ...
            try
            {
                _.CALLm1argp(this, _.NnO(oScripter, "oScripter"), "AddObject", _.ARGS.Val("hlcase").Ref(hlcase_vref2, v17 => { hlcase_vref2 = v17; }));
            }
            finally { hlcase = hlcase_vref2; }
            object mail_vref2 = mail;
            try
            {
                _.CALLm1argp(this, _.NnO(oScripter, "oScripter"), "AddObject", _.ARGS.Val("mail").Ref(mail_vref2, v18 => { mail_vref2 = v18; }));
            }
            finally { mail = mail_vref2; }

            _.CALLm1argp(this, _.NnO(_.CALLm0argp(this, _.NnO(_env.session, "session"), _.ARGS.Val("worker")), "(_.call result)"), "ExecuteScript", _.ARGS.Ref(oScripter, v19 => { oScripter = v19; }).Ref(_env.session, v20 => { _env.session = v20; }).Val("extend"));
        ...
        public void AssociateSenderToCase(ref object oMailRequest, ref object oCaseCfg, ref object oHLServer, ref object oCase)
        {
            ...
            // Suche
            //
            sMailAttributeKey = _.VAL(_.CALLm1v0(this, _.NnO(_.CALLm1v1(this, _.NnO(oCaseCfg, "oCaseCfg"), "GetValue", "MailAttributeKey"), "(_.call result)"), "data"));
            sSearchConditionPersons = _.CONCAT(sMailAttributeKey, "= \"", _.CALLm1v0(this, _.NnO(oMailRequest, "oMailRequest"), "SenderMail"), "\"");

            _.CALLm1v1(this, _outer, "LogText", _.CONCAT("SearchCondition = ", sSearchConditionPersons));
            oPersons = _.OBJ(_.CALLm1argp(this, _.NnO(oHLServer, "oHLServer"), "Find_Persons", _.ARGS.Ref(sSearchConditionPersons, v21 => { sSearchConditionPersons = v21; }).Val((Int16)0)));
            ...
            if (_.IF(_.EQ(_.NullableNUM(_.CALLm1v0(this, _.NnO(oPersons, "oPersons"), "Count")), (Int16)0)))
            {
                ...
                oPersons = _.OBJ(_.CALLm1argp(this, _.NnO(oHLServer, "oHLServer"), "Find_Persons", _.ARGS.Ref(sSearchConditionPersons, v22 => { sSearchConditionPersons = v22; }).Val((Int16)0)));
                if (_.IF(_.GT(_.NullableNUM(_.CALLm1v0(this, _.NnO(oPersons, "oPersons"), "Count")), (Int16)0)))
                {
                    _.CALLm1argp(this, _.NnO(oCase, "oCase"), "AssociatePersons", _.ARGS.Ref(oPersons, v23 => { oPersons = v23; }));
                }
            }
            else
            {
                _.CALLm1argp(this, _.NnO(oCase, "oCase"), "AssociatePersons", _.ARGS.Ref(oPersons, v24 => { oPersons = v24; }));
            }
        ...
        public object CreateCaseFromMail(ref object oMailRequest, ref object oCaseCfg, ref object oHLServer)
        {
            ...
            oCase = _.OBJ(_.CALLm1argp(this, _.NnO(oHLServer, "oHLServer"), "CreateCase", _.ARGS.Ref(sCaseType, v25 => { sCaseType = v25; })));
        ...
        public object ExtendCaseFromMail(ref object oMailRequest, ref object oCaseCfg, ref object oHLServer, ref object refNumber)
        {
            ...
            cases = _.OBJ(_.CALLm1argp(this, _.NnO(oHLServer, "oHLServer"), "find_Cases", _.ARGS.Ref(SearchCondition, v32 => { SearchCondition = v32; }).Val((Int16)0)));
        ...
        public void ExtendCase(ref object oCase, ref object oMailRequest, ref object oCaseCfg, ref object oHLServer)
        {
            ...
            _.CALLm1v0(this, _.NnO(oCase, "oCase"), "createSU");
            ...
            try
            {
                _.CALLm1argp(this, _outer, "SetSUAttributes", _.ARGS.Val(_.CALLm1v0(this, _.NnO(oCase, "oCase"), "getHLObject")).Ref(oMailRequest_vref6, v41 => { oMailRequest_vref6 = v41; }));
            }
            finally { oMailRequest = oMailRequest_vref6; }

            _.CALLm1v0(this, _.NnO(oCase, "oCase"), "mergeSUs");

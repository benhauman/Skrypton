...
namespace TranslatedProgram
{
    ...
    public sealed class GlobalReferences : GlobalReferencesBaseT<EnvironmentReferences>
    {
        ...
        public void AssociateSenderToCase(ref object oMailRequest, ref object oCaseCfg, ref object oHLServer, ref object oCase)
        {
            ...
            // Suche
            //
            sMailAttributeKey = _.VAL(_.CALLm1v0(this, _.CALLm1v1(this, oCaseCfg ?? throw new InvalidOperationException("Reference not set:oCaseCfg"), "GetValue", "MailAttributeKey") ?? throw new InvalidOperationException("Reference not set:"), "data"));

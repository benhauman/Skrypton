...
namespace TranslatedProgram
{
    public sealed class Runner : RunnerBaseT<EnvironmentReferences, GlobalReferences>
    {
        ...
        protected override void Go(IProvideVBScriptCompatFunctionalityToIndividualRequests compatLayer, EnvironmentReferences env, GlobalReferences globalReferences)
        {
            ...
            if (_.IF(_.EQ(_outer.priority, "A")))
            {
                _.CALLm1v5(this, _env.hlObj ?? throw new InvalidOperationException("Reference not set:hlObj"), "SetValue", "CaseGeneral.Priority", (Int16)101, (Int16)102, (Int16)103, "PriorityNormal");
            }
            else if (_.IF(_.EQ(_outer.priority, "B")))
            {
                _.CALLm1v5(this, _env.hlObj ?? throw new InvalidOperationException("Reference not set:hlObj"), "SetValue", "CaseGeneral.Priority", (Int16)201, (Int16)202, (Int16)203, "PriorityMedium");
            }
            else
            {
                _.CALLm1v5(this, _env.hlObj ?? throw new InvalidOperationException("Reference not set:hlObj"), "SetValue", "CaseGeneral.Priority", (Int16)901, (Int16)902, (Int16)903, "");
            }
        }
    }

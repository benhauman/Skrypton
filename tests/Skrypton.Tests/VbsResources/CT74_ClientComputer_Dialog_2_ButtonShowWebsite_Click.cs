    ...
    public sealed class GlobalReferences : GlobalReferencesBaseT<EnvironmentReferences>
    {
        ...
        public void ButtonShowWebsite_Click()
        {
            ...
            if (_.IF(_.EQ(_.NullableNUM(_.CALLm1v0(this, _env.hlObj, "IsNew")), (Int16)1)))
            {
                ...
                _.SETm1a0(this, with, "ActiveConnection", _.OBJ(oConn));
                _.SETm1a0(this, with, "CommandText", "CreateNewSBCode");
                _.SETm1a0(this, with, "CommandType", _.VAL(adCmdStoredProc));
                ...
                _.SETm1a0(this, with2, "ActiveConnection", _.OBJ(oConn));
                _.SETm1a0(this, with2, "CommandText", "CreateNewPersonalID");
                _.SETm1a0(this, with2, "CommandType", _.VAL(adCmdStoredProc));

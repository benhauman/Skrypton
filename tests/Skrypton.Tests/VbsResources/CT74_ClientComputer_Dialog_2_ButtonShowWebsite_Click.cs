    ...
    public sealed class GlobalReferences : GlobalReferencesBaseT<EnvironmentReferences>
    {
        ...
        public void ButtonShowWebsite_Click()
        {
            ...
            if (_.IF(_.EQ(_.NullableNUM(_.CALL(this, _env.hlObj, "IsNew")), (Int16)1)))
            {
                ...
                _.CALL(this, with, "Parameters", "Append", _.ARGS.Val(_.CALL(this, with, "CreateParameter", _.ARGS.Val("RETURN_VALUE").Val(adInteger).Val(adParamReturnValue))));
                _.CALL(this, with, "Parameters", "Append", _.ARGS.Val(_.CALL(this, with, "CreateParameter", _.ARGS.Val("@FirstCharName").Val(adVarWChar).Val(adParamInput).Val((Int16)1).Ref(FirstCharName, v4 => { FirstCharName = v4; }))));
                _.CALL(this, with, "Parameters", "Append", _.ARGS.Val(_.CALL(this, with, "CreateParameter", _.ARGS.Val("@NewSBCode").Val(adVarWChar).Val(adParamOutput).Val((Int16)10))));
                ...
                _.CALL(this, with2, "Parameters", "Append", _.ARGS.Val(_.CALL(this, with2, "CreateParameter", _.ARGS.Val("RETURN_VALUE").Val(adInteger).Val(adParamReturnValue))));
                _.CALL(this, with2, "Parameters", "Append", _.ARGS.Val(_.CALL(this, with2, "CreateParameter", _.ARGS.Val("@TypeCode").Val(adVarWChar).Val(adParamInput).Val((Int16)1).Ref(xvIdentifier, v6 => { xvIdentifier = v6; }))));
                _.CALL(this, with2, "Parameters", "Append", _.ARGS.Val(_.CALL(this, with2, "CreateParameter", _.ARGS.Val("@NewPersonalID").Val(adVarWChar).Val(adParamOutput).Val((Int16)10))));

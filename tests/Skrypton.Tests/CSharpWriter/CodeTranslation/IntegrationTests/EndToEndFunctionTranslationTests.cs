    ...
    public class EndToEndFunctionTranslationTests : TestBase
    {
        ...
        public void IfTheOnlyExecutableStatementIsReturnValueThenTranslateIntoSingleReturnStatementUnlessRefAliasMappingsRequired()
        {
            ...
            var expected = new[]
            {
                ...
                "    try",
                "    {",
                "        F1_retVal = _.VAL(_.CALL(this, _outer, \"F2\", _.ARGS.Ref(byrefalias3, v => { byrefalias3 = v; })));",
                "    }",
        ...
        public void ByRefFunctionArgumentRequiresSpecialTreatmentIfDirectlyUsedElsewhereAsByRefArgument()
        {
            ...
            var expected = new[]
            {
                ...
                "    try",
                "    {",
                "        _.CALL(this, _outer, \"F2\", _.ARGS.Ref(byrefalias, v => { byrefalias = v; }));",
                "    }",
        ...
        public void ByRefFunctionArgumentRequiresSpecialTreatmentIfDirectlyUsedElsewhereAsAnArrayAsByRefArgument()
        {
            ...
            var expected = new[]
            {
                ...
                "    try",
                "    {",
                "        _.CALL(this, _outer, \"F2\", _.ARGS.RefIfArray(byrefalias, _.ARGS.Val((Int16)0)));",
                "    }",
                "    finally { a = byrefalias; }",
                "    return F1_retVal;",
                "}",
        ...
        public void ByRefFunctionArgumentMustBeMappedToReadAndWriteAliasIfReferencedInReadAndWriteMannerWithinPotentiallyErrorTrappingStatement()
        {
            ...
            var expected = new[]
            {
                ...
                "    {",
                "        _.HANDLEERROR(errOn, () => {",
                "            _.CALL(this, _env.WScript, \"Echo\", _.ARGS.Ref(byrefalias, v => { byrefalias = v; }));",
                "        });",
                "    }",
                "    finally { a = byrefalias; }",
        ...
        public void ByRefFunctionArgumentMustBeMappedToReadOnlyAliasIfReferencedInReadOnlyMannerWithinPotentiallyErrorTrappingStatement()
        {
            ...
            var expected = new[]
            {
                ...
                "    object byrefalias = a;",
                "    _.HANDLEERROR(errOn, () => {",
                "        _.CALL(this, _env.WScript, \"Echo\", _.ARGS.Val(_.CALL(this, byrefalias, \"Name\")));",
                "    });",
                "    _.RELEASEERRORTRAPPINGTOKEN(errOn);",
                "    return F1_retVal;",
                "}"

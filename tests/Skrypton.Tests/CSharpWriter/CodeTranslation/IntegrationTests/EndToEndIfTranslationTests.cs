...
{
    [TestClass]
    public class EndToEndIfTranslationTests : TestBase
    {
        /// <summary>
        ...
        /// </summary>
        public class NumericLiteralSpecialCases : TestBase
        {
            /// <summary>
        ...
        /// </summary>
        public class StringLiteralSpecialCases : TestBase
        {
            /// <summary>
        ...
        [TestClass]
        public class ByRefArgumentsOfContainingFunctionSpecialCases : TestBase
        {
            /// <summary>

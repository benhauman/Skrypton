    ...
    public sealed class DefaultRuntimeSupportClassFactory
    {
        ...
        private DefaultRuntimeSupportClassFactory(IRuntimeLogger runtimeLogger, CultureInfo culture)
        {
            ...
            DefaultVBScriptValueRetriever = new VBScriptEsqueValueRetriever(
                _defaultNameRewriter.RewriteName,
        ...
        /// </summary>
        private readonly DefaultVBScriptNameRewriter _defaultNameRewriter;

        internal static string RewriteName(string valueIn)//, int lineIndex)
        {
            if (valueIn == null)
            ...
            string value = valueIn;// valueIn.ToLower();

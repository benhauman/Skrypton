...
{
    /// <summary>
    /// Sometimes an codeExpression needs to be rewritten after some of it has been processed such that, not only must it not be pushed through the name rewriter again, the scope

    ...
    internal abstract class CodeBlockTranslator
    {
                    ...
                    constStatement.Values
                        ...
                        new TranslatedStatement(
                            string.Format(CultureInfo.InvariantCulture,
                                ...
                                _statementTranslator.Translate(new CodeExpression(new[] { value.Value }), scopeAccessInformation, ExpressionReturnTypeOptions.Value, _logger.Warning).TranslatedContent
                            ),
                            indentationDepth,
        ...
        protected TranslationResult? TryToTranslateDim(TranslationResult translationResult, ICodeBlock block, ScopeAccessInformation scopeAccessInformation, int indentationDepth)
        {
            ...
            return translationResult.AddExplicitVariableDeclarations(
                explicitVariableDeclarationBlock.Variables.Cast<ConstantNonNegativeArrayDimensionDimVariable>().Select(v => new VariableDeclaration(
                    v.Name,
        ...
        {
            // This covers Statement and ParsingExpression instances as ParsingExpression inherits from Statement
        ...
        protected TranslationResult? TryToTranslateValueSettingStatement(TranslationResult translationResult, ICodeBlock block, ScopeAccessInformation scopeAccessInformation, int indentationDepth)
        {
            ...
            byRefArgumentsToRewrite = byRefArgumentIdentifier.GetByRefArgumentsThatNeedRewriting(
                valueSettingStatement.Expression.ToStageTwoParserExpression(
                    scopeAccessInformation,
                    (valueSettingStatement.ValueSetType == ValueSetTypeOptions.Set) ? ExpressionReturnTypeOptions.Reference : ExpressionReturnTypeOptions.Value,
                    _logger.Warning
                ),
                scopeAccessInformation,
                byRefArgumentsToRewrite

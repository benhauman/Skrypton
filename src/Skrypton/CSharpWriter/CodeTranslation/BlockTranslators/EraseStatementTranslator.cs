...
{
    internal sealed class EraseStatementTranslator : CodeBlockTranslator
    {
        ...
        public TranslationResult Translate(EraseStatement eraseStatement, ScopeAccessInformation scopeAccessInformation, int indentationDepth)
        {
            ...
            if (exceptionStatementIfTargetConfigurationIsInvalid != null)
            {
                foreach (EraseStatement.TargetDetails? target in eraseStatement.Targets)
                {
                    ...
                    LogUndeclaredVariables(undeclaredVariablesReferencedByTarget, eraseStatement, scopeAccessInformation);
            ...
            else
            {
                ...
                LogUndeclaredVariables(undeclaredVariablesInSingleEraseTarget, eraseStatement, scopeAccessInformation);
                ...
                else
                {
                    ...
                    LogUndeclaredVariables(undeclaredVariablesInArguments, eraseStatement, scopeAccessInformation);

...
namespace Skrypton.LegacyParser
{
    ...
    {
        public static CSharpWriter.CodeTranslation.IOutermostScope ParseToOutermostScope(string scriptContent)
        {
            ...
            IEnumerable<ICodeBlock> rootCodeBlocks = Parser.Parse(scriptContent);

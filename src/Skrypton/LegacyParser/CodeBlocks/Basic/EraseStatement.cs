...
namespace Skrypton.LegacyParser.CodeBlocks.Basic
{
    ...
    public class EraseStatement : IHaveNonNestedExpressions
    {
        ...
        /// </summary>
        [DataMember] public IEnumerable<TargetDetails> Targets { get; private set; }

        /// <summary>
        /// This will be useful for the runtime error message that must be generated if there are zero target
        /// </summary>
        [DataMember] public int KeywordLineIndex { get; private set; }
        ...
        public class TargetDetails
        {
            ...
            /// </summary>
            [DataMember] public bool WrappedInBraces { get; private set; }
        }
    }
}
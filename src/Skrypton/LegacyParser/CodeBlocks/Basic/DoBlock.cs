...
namespace Skrypton.LegacyParser.CodeBlocks.Basic
{
    ...
    public class DoBlock : ILoopOverNestedContent, ICodeBlock
    {
        ...
        /// </summary>
        [DataMember] public bool IsDoWhileCondition { get; private set; }
        ...
        /// </summary>
        [DataMember] public bool SupportsExit { get; private set; }
        ...
        /// </summary>
        [DataMember] public int LineIndexOfStartOfConstruct { get; private set; }

...
namespace Skrypton.LegacyParser.Tokens.Basic
{
    ...
    public sealed class NumericValueToken : AtomToken
    {
        ...
        public NumericValueToken(StringUpper contentUpper, int lineIndex) : base((contentUpper ?? throw new ArgumentNullException(nameof(contentUpper))).Original.Trim().ToUpperX(), WhiteSpaceBehaviourOptions.Disallow, lineIndex)
        {
